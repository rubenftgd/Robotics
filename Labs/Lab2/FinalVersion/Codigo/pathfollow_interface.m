...
%PATHFOLLOW_REAL_ANG Adaptação da unção homónima para ser utilizada com 
%a interface gráfica. 

%Leitura de informação a partir do handles
...
% Função que encontra o ponto da trajectória mais perto do ponto actual.
